...
import {
  ...
  withComponentRegistrar,
} from './withComponentRegistry';
...
export class Player implements MediaPlayer {
  ...
  render() {
    const label =
      `${this.isAudioView ? 'Audio Player' : 'Video Player'}` +
    ...
    const isBlockerVisible =
      !this.controls && canShowCustomUI && this.isVideoView;
