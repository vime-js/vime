...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			set_custom_element_data(vime_fullscreen_control, "keys", /*keys*/ ctx[4]);
			set_custom_element_data(vime_fullscreen_control, "is-fullscreen-active", /*isFullscreenActive*/ ctx[5]);
			set_custom_element_data(vime_fullscreen_control, "playback-ready", /*playbackReady*/ ctx[6]);
		},
		m(target, anchor) {
			...
			/*vime_fullscreen_control_binding*/ ctx[12](vime_fullscreen_control);
			current = true;
		},
		p(ctx, [dirty]) {
			if (default_slot) {
			...
			if (!current || dirty & /*isFullscreenActive*/ 32) {
				set_custom_element_data(vime_fullscreen_control, "is-fullscreen-active", /*isFullscreenActive*/ ctx[5]);
			}

			if (!current || dirty & /*playbackReady*/ 64) {
				set_custom_element_data(vime_fullscreen_control, "playback-ready", /*playbackReady*/ ctx[6]);
			}
		},
		i(local) {
		...
		d(detaching) {
			...
			/*vime_fullscreen_control_binding*/ ctx[12](null);
		}
	};
}
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ("isFullscreenActive" in $$props) $$invalidate(5, isFullscreenActive = $$props.isFullscreenActive);
		if ("i18n" in $$props) $$invalidate(8, i18n = $$props.i18n);
		if ("playbackReady" in $$props) $$invalidate(6, playbackReady = $$props.playbackReady);
