...
export const VimeDefaultUi = /*@__PURE__*/ Vue.extend({
  ...
  props: {
    noIcons: {} as PropOptions<Components.VimeDefaultUi['noIcons']>,
    noClickToPlay: {} as PropOptions<Components.VimeDefaultUi['noClickToPlay']>,
    noCaptions: {} as PropOptions<Components.VimeDefaultUi['noCaptions']>,
    noPoster: {} as PropOptions<Components.VimeDefaultUi['noPoster']>,
    noSpinner: {} as PropOptions<Components.VimeDefaultUi['noSpinner']>,
    noControls: {} as PropOptions<Components.VimeDefaultUi['noControls']>,
    noSettings: {} as PropOptions<Components.VimeDefaultUi['noSettings']>,
  },
