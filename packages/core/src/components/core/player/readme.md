...
| `vI18nChange`              | Emitted when the `i18n` prop changes value.                                                                                                                                                            | `CustomEvent<{ [x: string]: string; }>`                        |
...
| `vTranslationsChange`      | Emitted when the `translations` prop changes value.                                                                                                                                                    | `CustomEvent<{ [x: string]: Record<string, string>; }>`        |
