...
| `destroyed`          | `destroyed`            | `@readonly` Whether the player has disconnected from the DOM and been destroyed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | `boolean`                                         | `false`     |
...
| `mounted`            | `mounted`              | `@readonly` Whether the player has mounted the DOM.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `boolean`                                         | `false`     |
...
| `vDestroyed`               | Emitted when the player has disconnected from the DOM and been destroyed.                                                                                                                              | `CustomEvent<void>`                                            |
...
| `vMounted`                 | Emitted when the player has mounted the DOM.                                                                                                                                                           | `CustomEvent<void>`                                            |
