...
| `isCaptionsActive`   | --                   | `@readonly` Whether any captions or subtitles are currently showing.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | `boolean`                                         | `false`     |
...
| `isLive`             | --                   | `@readonly` Whether the current media is being broadcast live (`duration === Infinity`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | `boolean`                                         | `false`     |
...
| `isSettingsActive`   | --                   | `@readonly` Whether the settings menu has been opened and is currently visible. This is currently only supported by custom settings.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | `boolean`                                         | `false`     |
