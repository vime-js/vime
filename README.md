...
Overall this in simple terms means that:

* **Vime is compiled to plain old Vanilla JS**. You can use it anywhere, regardless what framework you choose.
* **Lightweight + Performant**. Svelte is able to at compile-time analyze our code and make optimizations
to reduce file size and increase performance. In addition, because it's not a framework the overhead
is extremely small, as only the code required is included and not an entire framework full of features
you may or may not use. This will only improve overtime.
...
* Poorly implemented **plugin system** or none at all. Again making it difficult for users and the community 
to extend the player or make certain features optional. Plyr doesn't have a plugin system, and most plugins for Videojs 
...
[package]: https://www.npmjs.com/package/@vime/player
...
[version-badge]: https://img.shields.io/npm/v/@vime/player?style=flat-square
