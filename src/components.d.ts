...
import {
  ...
  MediaPreloadOption,
} from './components/providers/file/MediaFileProvider';
import {
  TooltipDirection,
  TooltipPosition,
} from './components/ui/tooltip/types';
...
export namespace Components {
  ...
  interface VmMenu {
     ...
     */
    setActiveMenuItem: (
      item?: HTMLVmMenuItemElement | undefined,
    ) => Promise<void>;
    /**
  ...
  interface VmPlayer {
     ...
     */
    getAdapter: <InternalPlayerType = any>() => Promise<
     ...
     * @inheritDoc
     */
    getProvider: <InternalPlayerType = any>() => Promise<
...
declare global {
  ...
  interface HTMLVmEndTimeElement
    extends Components.VmEndTime,
      HTMLStencilElement {}
  ...
  interface HTMLVmFullscreenControlElement
    extends Components.VmFullscreenControl,
      HTMLStencilElement {}
  ...
  interface HTMLVmIconLibraryElement
    extends Components.VmIconLibrary,
      HTMLStencilElement {}
  var HTMLVmIconLibraryElement: {
    prototype: HTMLVmIconLibraryElement;
    new (): HTMLVmIconLibraryElement;
  };
  interface HTMLVmLiveIndicatorElement
    extends Components.VmLiveIndicator,
      HTMLStencilElement {}
  var HTMLVmLiveIndicatorElement: {
    prototype: HTMLVmLiveIndicatorElement;
    new (): HTMLVmLiveIndicatorElement;
  };
  interface HTMLVmLoadingScreenElement
    extends Components.VmLoadingScreen,
      HTMLStencilElement {}
  ...
  interface HTMLVmTimeProgressElement
    extends Components.VmTimeProgress,
      HTMLStencilElement {}
  var HTMLVmTimeProgressElement: {
    prototype: HTMLVmTimeProgressElement;
    new (): HTMLVmTimeProgressElement;
  };
  interface HTMLVmTooltipElement
    extends Components.VmTooltip,
      HTMLStencilElement {}
  ...
  interface HTMLVmVolumeControlElement
    extends Components.VmVolumeControl,
      HTMLStencilElement {}
  var HTMLVmVolumeControlElement: {
    prototype: HTMLVmVolumeControlElement;
    new (): HTMLVmVolumeControlElement;
  };
  interface HTMLVmYoutubeElement
    extends Components.VmYoutube,
      HTMLStencilElement {}
...
declare namespace LocalJSX {
  ...
  interface VmFile {
     ...
     */
    onVmMediaElChange?: (
      event: CustomEvent<HTMLAudioElement | HTMLVideoElement | undefined>,
    ) => void;
    /**
  ...
  interface VmMenu {
     ...
     */
    onVmActiveMenuItemChange?: (
      event: CustomEvent<HTMLVmMenuItemElement | undefined>,
    ) => void;
    /**
     * Emitted when the active submenu changes.
     */
    onVmActiveSubmenuChange?: (
      event: CustomEvent<HTMLVmSubmenuElement | undefined>,
    ) => void;
    /**
  ...
  interface VmPlayer {
     ...
     * @inheritDoc
     */
    onVmAudioTracksChange?: (
      event: CustomEvent<PlayerProps['audioTracks']>,
    ) => void;
    /**
     ...
     */
    onVmBufferingChange?: (
      event: CustomEvent<PlayerProps['buffering']>,
    ) => void;
    /**
     ...
     */
    onVmControlsChange?: (
      event: CustomEvent<PlayerProps['isControlsActive']>,
    ) => void;
    /**
     * Emitted when the `currentAudioTrack` prop changes value.
     * @inheritDoc
     */
    onVmCurrentAudioTrackChange?: (
      event: CustomEvent<PlayerProps['currentAudioTrack']>,
    ) => void;
    /**
     * Emitted when the `currentPoster` prop changes value.
     * @inheritDoc
     */
    onVmCurrentPosterChange?: (
      event: CustomEvent<PlayerProps['currentPoster']>,
    ) => void;
    /**
     * Emitted when the `currentProvider` prop changes value.
     * @inheritDoc
     */
    onVmCurrentProviderChange?: (
      event: CustomEvent<PlayerProps['currentProvider']>,
    ) => void;
    /**
    ...
    onVmCurrentSrcChange?: (
      event: CustomEvent<PlayerProps['currentSrc']>,
    ) => void;
    /**
     * Emitted when the `currentTextTrack` prop changes value.
     * @inheritDoc
     */
    onVmCurrentTextTrackChange?: (
      event: CustomEvent<PlayerProps['currentTextTrack']>,
    ) => void;
    /**
    ...
    onVmCurrentTimeChange?: (
      event: CustomEvent<PlayerProps['currentTime']>,
    ) => void;
    /**
    ...
    onVmFullscreenChange?: (
      event: CustomEvent<PlayerProps['isFullscreenActive']>,
    ) => void;
    /**
     ...
     */
    onVmLanguagesChange?: (
      event: CustomEvent<PlayerProps['languages']>,
    ) => void;
    /**
     ...
     * @inheritDoc
     */
    onVmMediaTitleChange?: (
      event: CustomEvent<PlayerProps['mediaTitle']>,
    ) => void;
    /**
     ...
     */
    onVmMediaTypeChange?: (
      event: CustomEvent<PlayerProps['mediaType']>,
    ) => void;
    /**
     ...
     * @inheritDoc
     */
    onVmPlaybackQualitiesChange?: (
      event: CustomEvent<PlayerProps['playbackQualities']>,
    ) => void;
    /**
    ...
    onVmPlaybackQualityChange?: (
      event: CustomEvent<PlayerProps['playbackQuality']>,
    ) => void;
    /**
     * Emitted when the `playbackRate` prop changes value.
     * @inheritDoc
     */
    onVmPlaybackRateChange?: (
      event: CustomEvent<PlayerProps['playbackRate']>,
    ) => void;
    /**
     * Emitted when the `playbackRates` prop changes value.
     * @inheritDoc
     */
    onVmPlaybackRatesChange?: (
      event: CustomEvent<PlayerProps['playbackRates']>,
    ) => void;
    /**
     ...
     * @inheritDoc
     */
    onVmTextTrackVisibleChange?: (
      event: CustomEvent<PlayerProps['isTextTrackVisible']>,
    ) => void;
    /**
     * Emitted when the `textTracks` prop changes value.
     * @inheritDoc
     */
    onVmTextTracksChange?: (
      event: CustomEvent<PlayerProps['textTracks']>,
    ) => void;
    /**
     ...
     * @inheritDoc
     */
    onVmTranslationsChange?: (
      event: CustomEvent<PlayerProps['translations']>,
    ) => void;
    /**
...
declare module '@stencil/core' {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      'vm-caption-control': LocalJSX.VmCaptionControl &
        JSXBase.HTMLAttributes<HTMLVmCaptionControlElement>;
      'vm-captions': LocalJSX.VmCaptions &
        JSXBase.HTMLAttributes<HTMLVmCaptionsElement>;
      'vm-click-to-play': LocalJSX.VmClickToPlay &
        JSXBase.HTMLAttributes<HTMLVmClickToPlayElement>;
      'vm-control': LocalJSX.VmControl &
        JSXBase.HTMLAttributes<HTMLVmControlElement>;
      'vm-control-group': LocalJSX.VmControlGroup &
        JSXBase.HTMLAttributes<HTMLVmControlGroupElement>;
      'vm-control-spacer': LocalJSX.VmControlSpacer &
        JSXBase.HTMLAttributes<HTMLVmControlSpacerElement>;
      'vm-controls': LocalJSX.VmControls &
        JSXBase.HTMLAttributes<HTMLVmControlsElement>;
      'vm-current-time': LocalJSX.VmCurrentTime &
        JSXBase.HTMLAttributes<HTMLVmCurrentTimeElement>;
      'vm-dailymotion': LocalJSX.VmDailymotion &
        JSXBase.HTMLAttributes<HTMLVmDailymotionElement>;
      'vm-dash': LocalJSX.VmDash & JSXBase.HTMLAttributes<HTMLVmDashElement>;
      'vm-dbl-click-fullscreen': LocalJSX.VmDblClickFullscreen &
        JSXBase.HTMLAttributes<HTMLVmDblClickFullscreenElement>;
      'vm-default-controls': LocalJSX.VmDefaultControls &
        JSXBase.HTMLAttributes<HTMLVmDefaultControlsElement>;
      'vm-default-settings': LocalJSX.VmDefaultSettings &
        JSXBase.HTMLAttributes<HTMLVmDefaultSettingsElement>;
      'vm-default-ui': LocalJSX.VmDefaultUi &
        JSXBase.HTMLAttributes<HTMLVmDefaultUiElement>;
      'vm-embed': LocalJSX.VmEmbed & JSXBase.HTMLAttributes<HTMLVmEmbedElement>;
      'vm-end-time': LocalJSX.VmEndTime &
        JSXBase.HTMLAttributes<HTMLVmEndTimeElement>;
      'vm-file': LocalJSX.VmFile & JSXBase.HTMLAttributes<HTMLVmFileElement>;
      'vm-fullscreen-control': LocalJSX.VmFullscreenControl &
        JSXBase.HTMLAttributes<HTMLVmFullscreenControlElement>;
      ...
      'vm-icon-library': LocalJSX.VmIconLibrary &
        JSXBase.HTMLAttributes<HTMLVmIconLibraryElement>;
      'vm-live-indicator': LocalJSX.VmLiveIndicator &
        JSXBase.HTMLAttributes<HTMLVmLiveIndicatorElement>;
      'vm-loading-screen': LocalJSX.VmLoadingScreen &
        JSXBase.HTMLAttributes<HTMLVmLoadingScreenElement>;
      'vm-menu': LocalJSX.VmMenu & JSXBase.HTMLAttributes<HTMLVmMenuElement>;
      'vm-menu-item': LocalJSX.VmMenuItem &
        JSXBase.HTMLAttributes<HTMLVmMenuItemElement>;
      'vm-menu-radio': LocalJSX.VmMenuRadio &
        JSXBase.HTMLAttributes<HTMLVmMenuRadioElement>;
      'vm-menu-radio-group': LocalJSX.VmMenuRadioGroup &
        JSXBase.HTMLAttributes<HTMLVmMenuRadioGroupElement>;
      'vm-mute-control': LocalJSX.VmMuteControl &
        JSXBase.HTMLAttributes<HTMLVmMuteControlElement>;
      'vm-pip-control': LocalJSX.VmPipControl &
        JSXBase.HTMLAttributes<HTMLVmPipControlElement>;
      'vm-playback-control': LocalJSX.VmPlaybackControl &
        JSXBase.HTMLAttributes<HTMLVmPlaybackControlElement>;
      'vm-player': LocalJSX.VmPlayer &
        JSXBase.HTMLAttributes<HTMLVmPlayerElement>;
      'vm-poster': LocalJSX.VmPoster &
        JSXBase.HTMLAttributes<HTMLVmPosterElement>;
      'vm-scrim': LocalJSX.VmScrim & JSXBase.HTMLAttributes<HTMLVmScrimElement>;
      'vm-scrubber-control': LocalJSX.VmScrubberControl &
        JSXBase.HTMLAttributes<HTMLVmScrubberControlElement>;
      'vm-settings': LocalJSX.VmSettings &
        JSXBase.HTMLAttributes<HTMLVmSettingsElement>;
      'vm-settings-control': LocalJSX.VmSettingsControl &
        JSXBase.HTMLAttributes<HTMLVmSettingsControlElement>;
      'vm-skeleton': LocalJSX.VmSkeleton &
        JSXBase.HTMLAttributes<HTMLVmSkeletonElement>;
      'vm-slider': LocalJSX.VmSlider &
        JSXBase.HTMLAttributes<HTMLVmSliderElement>;
      'vm-spinner': LocalJSX.VmSpinner &
        JSXBase.HTMLAttributes<HTMLVmSpinnerElement>;
      'vm-submenu': LocalJSX.VmSubmenu &
        JSXBase.HTMLAttributes<HTMLVmSubmenuElement>;
      'vm-time': LocalJSX.VmTime & JSXBase.HTMLAttributes<HTMLVmTimeElement>;
      'vm-time-progress': LocalJSX.VmTimeProgress &
        JSXBase.HTMLAttributes<HTMLVmTimeProgressElement>;
      'vm-tooltip': LocalJSX.VmTooltip &
        JSXBase.HTMLAttributes<HTMLVmTooltipElement>;
      ...
      'vm-volume-control': LocalJSX.VmVolumeControl &
        JSXBase.HTMLAttributes<HTMLVmVolumeControlElement>;
      'vm-youtube': LocalJSX.VmYoutube &
        JSXBase.HTMLAttributes<HTMLVmYoutubeElement>;
    }
  }
}
