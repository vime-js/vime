...
import {
  DailymotionCommand,
  DailymotionCommandArg,
} from './DailymotionCommand';
...
export class Dailymotion implements MediaProvider<HTMLVmEmbedElement> {
  ...
  private onEmbedMessage(event: CustomEvent<DailymotionMessage>) {
    ...
    switch (msg.event) {
      ...
      case DailymotionEvent.VideoEnd:
        if (this.loop) {
          setTimeout(() => {
            this.remoteControl(DailymotionCommand.Play);
          }, 300);
        } else {
  ...
  async getAdapter() {
    ...
    return {
      ...
      pause: async () => {
        this.remoteControl(DailymotionCommand.Pause);
      },
      ...
      enterFullscreen: async () => {
        this.remoteControl(DailymotionCommand.Fullscreen, true);
      },
      exitFullscreen: async () => {
        this.remoteControl(DailymotionCommand.Fullscreen, false);
      },
    };
  }
