...
| `currentProvider`    | `current-provider`     | `@readonly` The current provider name whose responsible for loading and playing media. Defaults to `undefined` when no provider has been loaded.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | `Provider.Audio ∣ Provider.Dailymotion ∣ Provider.Dash ∣ Provider.FakeTube ∣ Provider.HLS ∣ Provider.Video ∣ Provider.Vimeo ∣ Provider.YouTube ∣ undefined` | `undefined` |
...
| `vCurrentProviderChange`   | Emitted when the `currentProvider` prop changes value.                                                                                                                                                 | `CustomEvent<Provider.Audio ∣ Provider.Dailymotion ∣ Provider.Dash ∣ Provider.FakeTube ∣ Provider.HLS ∣ Provider.Video ∣ Provider.Vimeo ∣ Provider.YouTube ∣ undefined>` |
